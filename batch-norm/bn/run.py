...
l1_mean, l1_std, l2_mean, l2_std, loss_arr, model_type = train(model_type=ModelType.FF, num_epochs=2)
l1_mean_bn, l1_std_bn, l2_mean_bn, l2_std_bn, loss_arr_bn, model_type_bn = train(model_type=ModelType.BN, num_epochs=2)
...
# plot model loss
plt.plot(loss_arr, 'r', label='%s loss' % model_type)
plt.plot(loss_arr_bn, 'y', label='%s loss' % model_type_bn)
